...
//
// void main() {
//   // KakaoContext.clientId = 'b9a38eec8ae6c4e006a08a50b87c776f';
...
//           children: <Widget>[
//             ElevatedButton(child: Text('카카오톡으로 로그인'),
//         onPressed: _isKakaoTalkInstalled ? _loginWithKakao : null,),
//
//             ElevatedButton(
//               child: Text('친구 목록 가져오기'),
...
Future<void> main() async {
  ...
  LinuxInitializationSettings(
    ...
    defaultIcon: AssetsLinuxIcon('icons/home1.png'),
  );
