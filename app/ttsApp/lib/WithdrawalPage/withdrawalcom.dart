...
class Withdrawalcom extends StatelessWidget {
  @override
            ...
            Container(
              ...
              child: RichText(
                text: TextSpan(
                  ...
                  children: [
                    TextSpan(text: "그 동안 운전만해를\n이용해주셔서 감사합니다.\n"),
                    TextSpan(text: "더욱 나은 서비스로\n다시 고객님을 만나뵙는 날이 있었으면 좋겠습니다.\n편안한 운전 되시길 바랍니다.", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12,)),
                  ],
                ),
